...
| **Total real effort** | **~17.5 hr** | **35 hr committed to Adam personally** | Remaining against 35-hr commitment: ~17.5 hr. Real working budget = 35 hr (verbal commitment), engagement letter PDF says 40-45 hr but Adam's personal commitment is the operative number. |
| **Portal logged** | **~14.5 hr** | | Conservative under-count: real effort ~17.5 hr but portal logged ~14.5 hr (8h on 27 Jun aggregate + 2h on 28 Jun aggregate + 4.5h on 29 Jun split into Entry 1 GTM 2.5h + Entry 2 form pre-wire 0.5h + Entry 3 Netlify migration 1.5h). ~3 hr of real work absorbed as our overhead — internal admin (MVP_STATUS updates, our-side reference docs, memory files, weekly comms time) NOT separately billed. |
