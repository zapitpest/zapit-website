...
| 2.3 | Session 2: Build 8 GTM triggers + GA4 Configuration tag | ⬜ NEXT | Ready to execute (~1.5 hr) |
| 2.4 | Session 3: Build 5 GA4 form-submit event tags + 2 click event tags + QA pass | ⬜ | After 2.3 |
| 2.5 | Session 4: Meta Pixel base + Lead + Contact event tags | ⏳ | Adam grants Pixel access (Email 1 Ask 1) |
| 2.6 | Submit + Publish GTM Version 2 (supersedes empty Version 1) | ⬜ | After Sessions 2-4 |
| 2.7 | Mark 8 conversion events in GA4 admin | ⬜ | After 2.6 |
