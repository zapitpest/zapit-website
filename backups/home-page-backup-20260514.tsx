...
export const metadata: Metadata = {
  ...
  description: `Zapit delivers fast, licensed pest & termite control across Melbourne. DHHS-approved, protecting homes & businesses from pests. Call ${SITE_CONFIG.phone}.`,
...
export default function HomePage() {
  ...
  return (
    <>
            ...
            <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-14">
              <div>
                ...
                <p className="mb-4 text-[16px] leading-[1.7] text-white/80">
                  When pests invade, you need fast action. Our licensed technicians arrive the same day, equipped with the latest technology and DHHS-approved treatments to eliminate pests and prevent future infestations.
                </p>
                <ul className="mb-6 space-y-2 text-[15px] text-white/70">
                  {['Same-day emergency response', 'DHHS-approved, licensed treatments', 'Family-friendly approach', 'Comprehensive follow-up inspections'].map((t) => (
      ...
      {/* ===== 17. INSURED, LICENSED, ACCREDITED (ported from /residential) ===== */}
      <ScrollReveal direction="up">
        <section className="bg-[#f8f5f2] px-5 py-10 sm:px-6 sm:py-14">
          <div className="mx-auto max-w-3xl">
            ...
            <ul className="mb-8 space-y-4 text-[15px] text-[#414042] sm:text-[16px]">
              <li><p className="font-bold text-[#131a1c]">The Australian Environmental Pest Managers Association</p></li>
              <li><p className="font-bold text-[#131a1c]">HACCP Food Safety Certificate</p></li>
              <li><p className="font-bold text-[#131a1c]">VIC Government Wildlife Licence</p></li>
            </ul>
