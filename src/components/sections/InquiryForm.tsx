  ...
  return (
    <div className="mx-auto max-w-lg rounded-[20px] bg-[#F8F5F2] px-5 py-8 shadow-sm sm:max-w-xl sm:px-8 sm:py-10">
      ...
      <form className="space-y-3" onSubmit={(e) => e.preventDefault()}>
        ...
        <input type="email" placeholder="Email *" required className="w-full rounded-xl border border-[#e5e5e5] bg-white px-4 py-3 text-[15px] text-[#414042] placeholder:text-[#AFAAA4] focus:border-[#3fa535] focus:outline-none" />
