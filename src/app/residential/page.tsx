...
const PEST_PATHS: Record<PestType, React.ReactNode> = {
  magnify: (<><circle cx="10" cy="10" r="6" stroke={G} strokeWidth="2.2" fill="none"/><line x1="14.8" y1="14.8" x2="21" y2="21" stroke={G} strokeWidth="2.5" strokeLinecap="round"/></>),
  ant: (<><circle cx="12" cy="4.5" r="2.5" fill={G}/><ellipse cx="12" cy="10.5" rx="2" ry="3" fill={G}/><ellipse cx="12" cy="18" rx="3" ry="4" fill={G}/><line x1="10" y1="8.5" x2="6" y2="6.5" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="10" y1="11" x2="5" y2="11" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="10" y1="13" x2="6" y2="15" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="14" y1="8.5" x2="18" y2="6.5" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="14" y1="11" x2="19" y2="11" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="14" y1="13" x2="18" y2="15" stroke={G} strokeWidth="1.4" strokeLinecap="round"/></>),
  bird: (<><path d="M4 14 Q7 7 14 8 Q17 8 19 6 Q16 12 14 10 Q11 14 11 20 Q8 20 4 14Z" fill={G}/><circle cx="17" cy="7.5" r="1.5" fill={G}/></>),
  nest: (<><path d="M4 17 Q8 10 12 10 Q16 10 20 17" stroke={G} strokeWidth="2" fill="none" strokeLinecap="round"/><path d="M6 17 Q9 13 12 13 Q15 13 18 17" stroke={G} strokeWidth="1.5" fill="none" strokeLinecap="round"/><ellipse cx="10" cy="10" rx="2" ry="1.5" fill={G}/><ellipse cx="14" cy="10" rx="2" ry="1.5" fill={G}/></>),
  bedbug: (<><ellipse cx="12" cy="12" rx="6" ry="4.5" fill={G}/><circle cx="12" cy="8" r="2" fill={G}/><line x1="6" y1="10" x2="2.5" y2="7.5" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="6" y1="12" x2="2" y2="12" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="6" y1="14" x2="2.5" y2="16.5" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="18" y1="10" x2="21.5" y2="7.5" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="18" y1="12" x2="22" y2="12" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="18" y1="14" x2="21.5" y2="16.5" stroke={G} strokeWidth="1.4" strokeLinecap="round"/></>),
  moth: (<><path d="M12 12 C8 8 3 8 4 12 C5 15 9 14 12 12Z" fill={G}/><path d="M12 12 C16 8 21 8 20 12 C19 15 15 14 12 12Z" fill={G}/><path d="M12 12 C9 15 5 18 7 20 C9 21 11 17 12 12Z" fill={G}/><path d="M12 12 C15 15 19 18 17 20 C15 21 13 17 12 12Z" fill={G}/><ellipse cx="12" cy="12" rx="1.5" ry="5" fill={G}/></>),
  cobweb: (<><line x1="12" y1="2" x2="12" y2="22" stroke={G} strokeWidth="1.2"/><line x1="2" y1="12" x2="22" y2="12" stroke={G} strokeWidth="1.2"/><line x1="4.5" y1="4.5" x2="19.5" y2="19.5" stroke={G} strokeWidth="1.2"/><line x1="19.5" y1="4.5" x2="4.5" y2="19.5" stroke={G} strokeWidth="1.2"/><circle cx="12" cy="12" r="4.5" stroke={G} strokeWidth="1.2" fill="none"/><circle cx="12" cy="12" r="8.5" stroke={G} strokeWidth="1.2" fill="none"/></>),
  flea: (<><circle cx="13.5" cy="9.5" r="4" fill={G}/><circle cx="10.5" cy="6" r="2.5" fill={G}/><line x1="9.5" y1="13" x2="5" y2="18" stroke={G} strokeWidth="2.2" strokeLinecap="round"/><line x1="13" y1="13.5" x2="10" y2="20" stroke={G} strokeWidth="1.8" strokeLinecap="round"/><line x1="16" y1="12" x2="20" y2="15" stroke={G} strokeWidth="1.5" strokeLinecap="round"/></>),
  cockroach: (<><ellipse cx="12" cy="13" rx="5" ry="7" fill={G}/><ellipse cx="12" cy="7" rx="4" ry="3" fill={G}/><line x1="7" y1="10" x2="2" y2="8" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="7" y1="13" x2="2" y2="13" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="7" y1="16" x2="2" y2="18" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="17" y1="10" x2="22" y2="8" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="17" y1="13" x2="22" y2="13" stroke={G} strokeWidth="1.4" strokeLinecap="round"/><line x1="17" y1="16" x2="22" y2="18" stroke={G} strokeWidth="1.4" strokeLinecap="round"/></>),
  mouse: (<><circle cx="12" cy="14" r="6.5" fill={G}/><circle cx="7" cy="9" r="3" fill={G}/><circle cx="17" cy="9" r="3" fill={G}/><circle cx="7.5" cy="9" r="1.5" fill="white"/><circle cx="16.5" cy="9" r="1.5" fill="white"/><circle cx="10.5" cy="13" r="0.9" fill="white"/><circle cx="13.5" cy="13" r="0.9" fill="white"/><path d="M12 20 C15 22 19.5 21 22 17" stroke={G} strokeWidth="1.5" fill="none" strokeLinecap="round"/></>),
  mosquito: (<><ellipse cx="12" cy="14" rx="2" ry="5" fill={G}/><circle cx="12" cy="7.5" r="2.5" fill={G}/><line x1="12" y1="7.5" x2="12" y2="2" stroke={G} strokeWidth="1.8" strokeLinecap="round"/><path d="M12 11 C8 7.5 3.5 9 5 12" stroke={G} strokeWidth="1.5" fill="none" strokeLinecap="round"/><path d="M12 11 C16 7.5 20.5 9 19 12" stroke={G} strokeWidth="1.5" fill="none" strokeLinecap="round"/><line x1="8" y1="16" x2="4" y2="19" stroke={G} strokeWidth="1.3" strokeLinecap="round"/><line x1="12" y1="18.5" x2="10" y2="22" stroke={G} strokeWidth="1.3" strokeLinecap="round"/><line x1="16" y1="16" x2="20" y2="19" stroke={G} strokeWidth="1.3" strokeLinecap="round"/></>),
  possum: (<><circle cx="12" cy="14" r="6" fill={G}/><circle cx="12" cy="8.5" r="4" fill={G}/><path d="M8 6 C6 2.5 3 3.5 4.5 6.5" fill={G}/><path d="M16 6 C18 2.5 21 3.5 19.5 6.5" fill={G}/><circle cx="10" cy="8" r="1" fill="white"/><circle cx="14" cy="8" r="1" fill="white"/><ellipse cx="12" cy="10" rx="1.5" ry="0.8" fill="white"/></>),
  silverfish: (<><ellipse cx="13" cy="12" rx="8" ry="3" fill={G} transform="rotate(-15 13 12)"/><line x1="5" y1="9" x2="1.5" y2="7" stroke={G} strokeWidth="1.3" strokeLinecap="round"/><line x1="6" y1="12" x2="1.5" y2="13" stroke={G} strokeWidth="1.3" strokeLinecap="round"/><line x1="7" y1="15" x2="2.5" y2="17" stroke={G} strokeWidth="1.3" strokeLinecap="round"/><line x1="17" y1="9" x2="21" y2="7" stroke={G} strokeWidth="1.3" strokeLinecap="round"/><line x1="18" y1="12" x2="22.5" y2="12" stroke={G} strokeWidth="1.3" strokeLinecap="round"/><line x1="19" y1="15" x2="22" y2="17" stroke={G} strokeWidth="1.3" strokeLinecap="round"/></>),
  termite: (<><circle cx="12" cy="5" r="3" fill={G}/><line x1="10" y1="3.5" x2="7" y2="1" stroke={G} strokeWidth="1.5" strokeLinecap="round"/><line x1="14" y1="3.5" x2="17" y2="1" stroke={G} strokeWidth="1.5" strokeLinecap="round"/><ellipse cx="12" cy="12" rx="4" ry="5" fill={G}/><ellipse cx="12" cy="20" rx="4.5" ry="3.5" fill={G}/><line x1="8" y1="10" x2="3.5" y2="8" stroke={G} strokeWidth="1.5" strokeLinecap="round"/><line x1="8" y1="12" x2="3" y2="12" stroke={G} strokeWidth="1.5" strokeLinecap="round"/><line x1="8" y1="15" x2="3.5" y2="17" stroke={G} strokeWidth="1.5" strokeLinecap="round"/><line x1="16" y1="10" x2="20.5" y2="8" stroke={G} strokeWidth="1.5" strokeLinecap="round"/><line x1="16" y1="12" x2="21" y2="12" stroke={G} strokeWidth="1.5" strokeLinecap="round"/><line x1="16" y1="15" x2="20.5" y2="17" stroke={G} strokeWidth="1.5" strokeLinecap="round"/></>),
  wasp: (<><ellipse cx="12" cy="15" rx="4" ry="5.5" fill={G}/><rect x="8.5" y="13" width="7" height="1.5" rx="0.5" fill="white"/><rect x="8.5" y="16" width="7" height="1.5" rx="0.5" fill="white"/><circle cx="12" cy="7.5" r="3" fill={G}/><path d="M12 11 C7.5 7 3 9 5 12" fill={G}/><path d="M12 11 C16.5 7 21 9 19 12" fill={G}/><line x1="10" y1="6" x2="7" y2="2.5" stroke={G} strokeWidth="1.3" strokeLinecap="round"/><line x1="14" y1="6" x2="17" y2="2.5" stroke={G} strokeWidth="1.3" strokeLinecap="round"/></>),
          ...
          <div className="mx-auto max-w-xl text-center">
            ...
            <div className="mb-6 flex items-center justify-center gap-3">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-full bg-[#64FF01] px-6 py-2.5 text-[14px] font-bold text-[#414042] shadow-sm transition-transform hover:scale-105"
              >
