...
const COMMERCIAL_INDUSTRY_PAGES: Record<CommercialIndustrySlug, CommercialIndustryPage> = {
  ...
  'restaurants-pest-control': {
    ...
    metaDescription: 'Melbourne restaurant & café pest control. Discreet cockroach, fly, and rodent programs timed around service, kitchens, and back dock.',
  ...
  'government-buildings': {
    ...
    metaDescription: 'Melbourne government pest control. Documented service for public-sector sites with access control, after-hours clearances, and method statements.',
  ...
  transport: {
    ...
    metaDescription: 'Melbourne transport & logistics pest control. Rodent programs for depots, yards, workshops, and driver amenities. Reporting for freight compliance.',
  ...
  'food-manufacturing': {
    ...
    metaDescription: 'Melbourne food manufacturing pest control. GMP-aware IPM for production lines with monitoring, trend review, and pre-audit support for HACCP.',
  ...
  'aged-care-facilities': {
    ...
    metaDescription: 'Melbourne aged care pest control. Discreet ant, fly, cockroach, bed bug, and rodent programs scheduled around lifestyle teams and resident dignity.',
  ...
  hospitals: {
    ...
    metaDescription: 'Melbourne hospital pest control. Governed service for infection control, catering, and back dock. Ant, cockroach, fly, and rodent programs.',
  ...
  'educational-facilities': {
    ...
    metaDescription: 'Melbourne school & education pest control. Ant, wasp, rodent, and spider programs scheduled around term times, canteens, and campus priorities.',
  ...
  'distribution-center': {
    ...
    metaDescription: 'Melbourne distribution centre & 3PL pest control. Rodent and insect programs for racking, docks, and mezzanines. Weekend and out-of-hours service.',
