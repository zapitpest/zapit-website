...
const PEST_PRICE_LIST: ReadonlyArray<PestPriceItem> = [
  {
    ...
    name: 'General inspection', price: '$154', open: false,
  ...
  },
  {
    ...
    name: 'Localised ant treatment', price: '$299', open: false,
    ...
    detail: `Target pests: Common household ants\n\nWhat to expect after treatment:\n• Activity may increase 1 to 3 weeks as ants spread the product to colony\n• Gradual reduction in activity as the treatment takes effect\n\nImportant notes and exclusions:\n• Designed for light infestations only\n• Does not target deep nesting or multiple colonies\n• No warranty applies to this service\n\nThis service is effective in treating light or intermittent ant activity only. Suitable for when ant activity is detected early and before a large ant colony is established.\n\nIt is not effective for treating deep nested multiple ant colonies which may require more extensive treatment.\n\nAn elimination of deep rooted multi colonies, all homes. 60 minutes, $495 including GST`,
  },
  { n: 3, iconSlug: 'ant-elimination', name: 'Ant elimination', price: '$495', open: false, duration: '60 minutes', propertyType: 'All residential homes', inclusions: 'Deep nest elimination for established colonies.', verbalReport: 'Treatment summary and follow-up recommendations provided on completion', detail: 'An elimination of deep-rooted multi ant colonies in all homes.' },
  { n: 4, iconSlug: 'bed-bugs', name: 'Bed Bugs', price: '$495', open: false, duration: '60 minutes', propertyType: 'All residential homes', inclusions: 'Full bed bug and egg elimination.', verbalReport: 'Treatment summary and follow-up recommendations provided on completion', detail: 'Complete bed bug treatment including eggs and harbourage areas.' },
  { n: 5, iconSlug: 'clothes-carpet-moth', name: 'Clothes & carpet moth', price: '$423.50', open: false, duration: '90 minutes', propertyType: 'All residential homes', inclusions: 'Treatment of all moth-affected textile areas.', verbalReport: 'Treatment summary and follow-up recommendations provided on completion', detail: 'Targeted treatment for clothes and carpet moth infestations.' },
  { n: 6, iconSlug: 'fleas', name: 'Fleas', price: '$423.50', open: false, duration: '45 minutes', propertyType: 'All residential homes', inclusions: 'Pet-safe flea treatment breaking the lifecycle.', verbalReport: 'Treatment summary and follow-up recommendations provided on completion', detail: 'Targeted flea treatment designed for homes with pets.' },
  { n: 7, iconSlug: 'german-cockroach', name: 'German Cockroach', price: '$275', open: false, duration: '60 minutes', propertyType: 'All residential homes', inclusions: 'Gel baits and targeted sprays for German cockroaches.', verbalReport: 'Treatment summary and follow-up recommendations provided on completion', detail: 'Highly effective treatment for German cockroach infestations in kitchens and bathrooms.' },
  { n: 8, iconSlug: 'mice-rat-treatment', name: 'Mice & rat treatment', price: '$352', open: false, duration: '40 minutes', propertyType: 'All residential homes', inclusions: 'Bait stations, entry point sealing, monitoring.', verbalReport: 'Treatment summary and follow-up recommendations provided on completion', detail: 'Targeted rodent treatment using secure bait stations and entry point sealing.' },
  { n: 15, iconSlug: 'mice-rat-treatment', name: 'Mice & rat follow up visit', price: '$220', open: false, duration: '30 minutes', propertyType: 'All residential homes', inclusions: 'Bait stations replenished for rats, or entry points sealed for mice', verbalReport: 'Findings and next steps documented', detail: 'A paid follow up visit, not a warranty callback. For rats we replenish the bait stations. We do not seal a property against rats, because a rat gets through a gap the size of a $1 coin. For mice we seal the entry points we can find.' },
